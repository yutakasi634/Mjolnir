...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Mjolnir/flexsearch.min.js');loadScript('/Mjolnir/ja.search-data.min.c5a203747f42f7d9a4afe071735d08f544d8ee07cf2783c5638f374e977e80ee.js',function(){input.required=false;search();});}
