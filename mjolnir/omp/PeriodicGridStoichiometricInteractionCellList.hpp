#ifndef MJOLNIR_OMP_PERIODIC_GRID_STOICHIOMETRIC_INTERACTION_CELL_LIST_HPP
#define MJOLNIR_OMP_PERIODIC_GRID_STOICHIOMETRIC_INTERACTION_CELL_LIST_HPP
...
class PeriodicGridCellList<OpenMPSimulatorTraits<realT, boundaryT>, 
      GlobalStoichiometricInteractionPotential<OpenMPSimulatorTraits<realT, boundaryT>>
      > final : public SpatialPartitionBase<OpenMPSimulatorTraits<realT, boundaryT>,
      GlobalStoichiometricInteractionPotential<OpenMPSimulatorTraits<realT, boundaryT>>>
{
  public:

    using traits_type        = OpenMPSimulatorTraits<realT, boundaryT>;
    using potential_type     = GlobalStoichiometricInteractionPotential<OpenMPSimulatorTraits<realT, boundaryT>>;
  ...
  public:
                    ...
                    const system_type& sys, const potential_type& pot) override
    {
        ...
        std::cerr << "cell list for SI" << std::endl;
...
namespace mjolnir
{
extern template class PeriodicGridCellList<OpenMPSimulatorTraits<double, CuboidalPeriodicBoundary>, GlobalStoichiometricInteractionPotential<OpenMPSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class PeriodicGridCellList<OpenMPSimulatorTraits<float,  CuboidalPeriodicBoundary>, GlobalStoichiometricInteractionPotential<OpenMPSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;
}
#endif // SEPARATE_BUILD

#endif /* MJOLNIR_OMP_PERIODIC_GRID_STOICHIOMETRIC_INTERACTION_CELL_LIST */
